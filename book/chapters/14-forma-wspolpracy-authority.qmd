...
```{mermaid}
flowchart TD
    A["Czy organizacja wymaga osobistej, stałej dyspozycyjności?"] -->|Tak| B["Czy kieruje czasem, miejscem i bieżącym sposobem pracy?"]
    B -->|Tak| C["Silne cechy stosunku pracy"]
    B -->|Nie| D["Sprawdź wszystkie dominujące cechy relacji"]
    A -->|Nie| E["Czy istnieje jednorazowy, sprawdzalny rezultat?"]
    E -->|Tak| F["Możliwa umowa o dzieło"]
    E -->|Nie| G["Możliwe zlecenie, usługi lub B2B"]
```
